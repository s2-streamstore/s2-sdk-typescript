 ...
 * of that single batch client-side, matching the Rust, Go, and Python SDKs. The
 * result may be empty when every record in the batch was a command record; this
 * is intended behavior. Consumers that need to transparently keep reading until
 * data records are found should use `readSession()`.
 *
