...
declare class ReadSession<Data extends string | Uint8Array>
	implements AsyncDisposable, AsyncIterable<ReadEvent<Data>>
{
...
declare class AppendSession implements AsyncDisposable {
	...
	send<Data extends string | Uint8Array>(
		records: AppendRecord<Data> | AppendRecord<Data>[],
		opts?: BaseOptions,
	): Promise<void>;
}
...
declare class StreamService {
	read(
		args: ReadArgs<"string">,
		opts?: BaseOptions,
	): Promise<ReadResponse<string>>;
	read(
		args: ReadArgs<"bytes">,
		opts?: BaseOptions,
	): Promise<ReadResponse<Uint8Array>>;
	readSession(
		args?: ReadArgs<"string">,
		opts?: BaseOptions,
	): ReadSession<string>;
	readSession(
		args?: ReadArgs<"bytes">,
		opts?: BaseOptions,
	): ReadSession<Uint8Array>;
	append<Data extends string | Uint8Array>(
